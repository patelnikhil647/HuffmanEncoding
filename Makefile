...
compress: compress.cpp encoding.hpp Helper.cpp HCTree.cpp Helper.hpp HCTree.hpp
	$(CXX) $(CXXFLAGS) -o compress compress.cpp Helper.cpp HCTree.cpp

uncompress: uncompress.cpp encoding.hpp Helper.cpp HCTree.cpp Helper.hpp HCTree.hpp
