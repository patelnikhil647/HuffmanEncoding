...
class FancyInputStream {
    ...
    public:
        ...
        /**
         * Read a single (3-byte) integer from the file,
         * or crash if there are not enough bytes left in the file
         */
        int read_shorter_int();
...
class FancyOutputStream {
    ...
    public:
        ...
        /**
         * Write a single integer using only 3-bytes to the file
         */
        void write_shorter_int(int const & num);
